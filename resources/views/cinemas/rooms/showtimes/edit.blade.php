            ...
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <form method="POST" action="{{ route('showtime.update', $showtime->id) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" id="start_time" name="start_time" required value="{{ old('start_time', $showtime->start_time) }}"
                     ...
                     <div>
                        ...
                        <input type="datetime-local" id="end_time" name="end_time" required value="{{ old('end_time', $showtime->end_time) }}"
